...
export const E2E_TOUCHFILES: Record<string, string[]> = {
	...
	"comply-report": [
		"skills/comply-report/**",
		"bin/comply-audit-packet",
		"bin/comply-attest",
	],
...
export const LLM_JUDGE_TOUCHFILES: Record<string, string[]> = {
	"comply-scan report quality": [
		"skills/comply-scan/**",
		"nist/**",
		"scripts/gen-skill-docs.ts",
	],
	"comply-assess interview flow": [
		"skills/comply-assess/**",
		"nist/**",
		"scripts/gen-skill-docs.ts",
	],
	"comply-auto full pipeline": [
		"skills/comply-auto/**",
		"nist/**",
		"bin/comply-db",
	],
	"comply-fix remediation quality": [
		"skills/comply-fix/**",
		"scripts/gen-skill-docs.ts",
	],
	"comply-report completeness": [
		"skills/comply-report/**",
		"bin/comply-audit-packet",
	],
	"comply-breach response flow": [
		"skills/comply-breach/**",
		"scripts/gen-skill-docs.ts",
	],
