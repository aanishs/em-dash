...
import { setupTestProject, setupEmdashBins, preseedState, recordE2E } from './helpers/e2e-helpers';
...
if (!EVALS && !EVALS_ALL) {
  ...
  if (EVALS_ALL) {
    ...
    if (selection.skipped.length > 0) {
      console.log(`Touchfile skip: ${selection.skipped.join(', ')} (${selection.reason})`);
    }
  }
