...
console.log(`  E2E selection (${e2e.reason}): ${e2e.selected.length}/${Object.keys(E2E_TOUCHFILES).length} tests`);
...
console.log(`  LLM-judge selection (${llm.reason}): ${llm.selected.length}/${Object.keys(LLM_JUDGE_TOUCHFILES).length} tests`);
