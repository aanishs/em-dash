...
const AUTHORITATIVE_MAPPING: Record<
	string,
	{ controls: string[]; name: string }
> = {
	...
	"164.308(a)(1)(i)": {
		controls: ["PL-1", "PM-1"],
		name: "Security Management Process (S)",
	},
	"164.308(a)(1)(ii)(A)": {
		controls: ["RA-3", "RA-5"],
		name: "Risk Analysis (R)",
	},
	"164.308(a)(1)(ii)(B)": {
		controls: ["RA-3", "PM-9"],
		name: "Risk Management (R)",
	},
	"164.308(a)(1)(ii)(C)": {
		controls: ["PS-8", "PL-4"],
		name: "Sanction Policy (R)",
	},
	"164.308(a)(1)(ii)(D)": {
		controls: ["AU-6", "CA-7"],
		name: "Information System Activity Review (R)",
	},

	// Assigned Security Responsibility
	"164.308(a)(2)": {
		controls: ["PM-2"],
		name: "Assigned Security Responsibility (R)",
	},

	// Workforce Security
	"164.308(a)(3)(i)": {
		controls: ["PS-1", "PS-2"],
		name: "Workforce Security (S)",
	},
	"164.308(a)(3)(ii)(A)": {
		controls: ["AC-2", "PS-2"],
		name: "Authorization and/or Supervision (A)",
	},
	"164.308(a)(3)(ii)(B)": {
		controls: ["PS-3"],
		name: "Workforce Clearance Procedure (A)",
	},
	"164.308(a)(3)(ii)(C)": {
		controls: ["PS-4"],
		name: "Termination Procedures (A)",
	},

	// Information Access Management
	"164.308(a)(4)(i)": {
		controls: ["AC-1"],
		name: "Information Access Management (S)",
	},
	"164.308(a)(4)(ii)(A)": {
		controls: ["SC-2", "AC-4"],
		name: "Isolating Healthcare Clearinghouse Functions (R)",
	},
	"164.308(a)(4)(ii)(B)": {
		controls: ["AC-2", "AC-3"],
		name: "Access Authorization (A)",
	},
	"164.308(a)(4)(ii)(C)": {
		controls: ["AC-2", "AC-5", "AC-6"],
		name: "Access Establishment and Modification (A)",
	},

	// Security Awareness and Training
	"164.308(a)(5)(i)": {
		controls: ["AT-2"],
		name: "Security Awareness and Training (S)",
	},
	"164.308(a)(5)(ii)(A)": {
		controls: ["AT-2"],
		name: "Security Reminders (A)",
	},
	"164.308(a)(5)(ii)(B)": {
		controls: ["SI-3"],
		name: "Protection from Malicious Software (A)",
	},
	"164.308(a)(5)(ii)(C)": {
		controls: ["AC-7", "AU-2"],
		name: "Log-in Monitoring (A)",
	},
	"164.308(a)(5)(ii)(D)": {
		controls: ["IA-5"],
		name: "Password Management (A)",
	},

	// Security Incident Procedures
	"164.308(a)(6)(i)": {
		controls: ["IR-1", "IR-6"],
		name: "Security Incident Procedures (S)",
	},
	"164.308(a)(6)(ii)": {
		controls: ["IR-4", "IR-5", "IR-6"],
		name: "Response and Reporting (R)",
	},

	// Contingency Plan
	"164.308(a)(7)(i)": {
		controls: ["CP-1", "CP-2"],
		name: "Contingency Plan (S)",
	},
	"164.308(a)(7)(ii)(A)": { controls: ["CP-9"], name: "Data Backup Plan (R)" },
	"164.308(a)(7)(ii)(B)": {
		controls: ["CP-10"],
		name: "Disaster Recovery Plan (R)",
	},
	"164.308(a)(7)(ii)(C)": {
		controls: ["CP-2"],
		name: "Emergency Mode Operation Plan (R)",
	},
	"164.308(a)(7)(ii)(D)": {
		controls: ["CP-4"],
		name: "Testing and Revision Procedures (A)",
	},
	"164.308(a)(7)(ii)(E)": {
		controls: ["RA-2", "CP-2"],
		name: "Applications and Data Criticality Analysis (A)",
	},
	...
	"164.308(b)(1)": {
		controls: ["SA-9"],
		name: "Business Associate Contracts (R)",
	},
	...
	"164.310(a)(1)": {
		controls: ["PE-2", "PE-3"],
		name: "Facility Access Controls (S)",
	},
	"164.310(a)(2)(i)": {
		controls: ["CP-2", "PE-1"],
		name: "Contingency Operations (A)",
	},
	"164.310(a)(2)(ii)": {
		controls: ["PE-3"],
		name: "Facility Security Plan (A)",
	},
	"164.310(a)(2)(iii)": {
		controls: ["PE-2", "PE-3"],
		name: "Access Control and Validation Procedures (A)",
	},
	"164.310(a)(2)(iv)": {
		controls: ["MA-2", "MA-5"],
		name: "Maintenance Records (A)",
	},
	...
	"164.310(d)(1)": {
		controls: ["MP-1", "MP-2"],
		name: "Device and Media Controls (S)",
	},
	...
	"164.310(d)(2)(iv)": {
		controls: ["CP-9"],
		name: "Data Backup and Storage (A)",
	},
	...
	"164.312(a)(1)": {
		...
		name: "Access Control (S)",
	},
	"164.312(a)(2)(i)": {
		controls: ["IA-2", "IA-4"],
		name: "Unique User Identification (R)",
	},
	"164.312(a)(2)(ii)": {
		controls: ["CP-2"],
		name: "Emergency Access Procedure (R)",
	},
	"164.312(a)(2)(iii)": { controls: ["AC-11"], name: "Automatic Logoff (A)" },
	"164.312(a)(2)(iv)": {
		controls: ["SC-28"],
		name: "Encryption and Decryption (A)",
	},

	// Audit Controls
	"164.312(b)": {
		controls: ["AU-2", "AU-3", "AU-6", "AU-12"],
		name: "Audit Controls (R)",
	},
	...
	"164.312(c)(2)": {
		controls: ["SI-7"],
		name: "Mechanism to Authenticate ePHI (A)",
	},

	// Person or Entity Authentication
	"164.312(d)": {
		controls: ["IA-2", "IA-5"],
		name: "Person or Entity Authentication (R)",
	},
	...
	"164.314(a)(1)": {
		controls: ["SA-9"],
		name: "Business Associate Contracts or Other Arrangements (S)",
	},
	"164.314(a)(2)(i)": {
		controls: ["SA-9"],
		name: "Business Associate Contracts (R)",
	...
	"164.502": {
		controls: ["AC-3"],
		name: "Uses and Disclosures (em-dash extension)",
	},
	"164.514": {
		controls: ["SI-12"],
		name: "Data Minimization (em-dash extension)",
	},
};
...
const missingControls: { spec: string; missing: string[] }[] = [];
const extraControls: { spec: string; extra: string[] }[] = [];

// Check for missing specs (in authoritative but not in filter)
for (const [spec, { controls, name }] of Object.entries(
...
console.log(
	`Authoritative:  ${Object.keys(AUTHORITATIVE_MAPPING).length} specs`,
);
console.log();
...
if (extraSpecs.length > 0) {
	console.log(
		`EXTRA SPECS (${extraSpecs.length}) — in filter but not in authoritative:`,
	);
...
if (extraControls.length > 0) {
	console.log(
		`EXTRA CONTROLS (${extraControls.length} specs — in filter but not in authoritative):`,
	);
...
const newControls = [...allAuthControls].filter(
	(c) => !allCurrentControls.has(c),
);
...
if (totalIssues === 0) {
	...
	console.log(
		`TOTAL: ${missingSpecs.length} missing specs, ${missingControls.length} specs with missing controls`,
	);
}
...
if (FIX_MODE && totalIssues > 0) {
	...
	console.log(
		`  Specs: ${Object.keys(currentMapping).length} → ${Object.keys(newMapping).length}`,
	);
	console.log(
		`  Controls: ${allCurrentControls.size} → ${new Set([...allAuthControls, ...allCurrentControls]).size}`,
	);
}
